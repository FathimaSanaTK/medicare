...
export default function ChatBot() {
  ...
  const handleSend = async () => {
    ...
    let prompt = `You are a doctor with 20 years of experience. The patient is asking: "${userInput}". Provide a non-lethal, simple solution, respond like a text message without any text formatting and don't say let me know.`;
